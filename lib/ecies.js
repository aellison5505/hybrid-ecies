...
var ECIES = /** @class */ (function () {
    ...
    ECIES.prototype.encryptAES256 = function (publicKey, arg2, arg3) {
        var privateKey;
        var data;
        if (arg2 && arg3) {
            privateKey = arg2;
        ...
        var key = this.getSecret(privateKey, publicKey);
        // console.log('key', key.toString('hex'));
        var aes = crypto_1.createCipheriv('aes-256-gcm', key, iv);
        var encData = aes.update(data);
        aes.final();
        var tag = aes.getAuthTag();
        var pack = Buffer.concat([this.getPublicKey(privateKey, true), iv, tag, encData]);
        return pack;
    };
    /**
    ...
    */
    ...
    ECIES.prototype.encryptChaCha20 = function (publicKey, arg2, arg3) {
        var privateKey;
        var data;
        if (arg2 && arg3) {
            privateKey = arg2;
        ...
        var pack = Buffer.concat([this.getPublicKey(privateKey, true), nonce, tag, encData]);
